...
import { Avatar, Button, FormControl, Heading, HStack, Input, Text, VStack } from 'native-base';
...
const EditAccount = () => {
  ...
  return (
    ...
    >
        ...
        <Avatar bg="amber.500" source={{ uri: 'https://imgs.search.brave.com/sPPpVQcHjjA7hi9kQkQcaxub5zLmjd4QMvose6-svlM/rs:fit:844:225:1/g:ce/aHR0cHM6Ly90c2U0/Lm1tLmJpbmcubmV0/L3RoP2lkPU9JUC5u/OTE2d3E3TkMtcDZa/M3otdEZxQmdBSGFF/SyZwaWQ9QXBp' }} size="xl"
        >
        NB
        ...
        {
            showModal && <ChangeAvatar showModal={showModal} setShowModal={setShowModal} />
        }

        {
            showModalNotify && <Popup showModal={showModalNotify} setShowModal={setShowModalNotify} isSuccess={false} onPress={handleNavigate} />
        }

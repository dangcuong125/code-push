            ...
            >
              ...
              >
                <HStack 
                  ...
                  alignItems={'center'}
                >
                  <Ionicons name="md-notifications-outline" size={23} color={'#292D32'} />
                  <Text 
                    color={'#000000'}
                    fontStyle={'normal'}
                    fontSize={'14px'}
            ...
            >
              ...
              >
                <HStack 
                  ...
                  alignItems={'center'}
                >
                  <MaterialCommunityIcons name="format-text" size={23} color={'#292D32'} />
                  <Text 
                    color={'#000000'}
                    fontStyle={'normal'}
                    fontSize={'14px'}
            ...
            >
              ...
              >
                <HStack 
                  ...
                  alignItems={'center'}
                >
                  <MaterialCommunityIcons name="information-outline" size={23} color={'#292D32'} />
                  <Text 
                    color={'#000000'}
                    fontStyle={'normal'}
                    fontSize={'14px'}

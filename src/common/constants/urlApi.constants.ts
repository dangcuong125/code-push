...
export const GET_WORD_GROUP_LIST = '/user-save-words/group';
export const CREATE_NEW_FOLDER_FOR_SAVING_WORD = '/user-save-words/group';
export const GET_SAVED_WORD_LIST = '/user-save-words/word';
export const GET_SAVED_WORD_DETAIL = '/admin/dictionaries';
export const SAVE_NEW_WORD = '/user-save-words/word';
export const DELETE_SAVED_WORD = '/user-save-words/word';

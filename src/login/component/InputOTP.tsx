...
import { Image, Dimensions, TextInput, View, TouchableOpacity } from 'react-native';
import { Box, Button, Center, Divider, Heading, Input, Text, VStack, HStack } from 'native-base';
...
const InputOTP = ({route, navigation}: InputOTPProps) => {
    ...
    const onSubmitOTP = async () => {
        if(internalValue.length === lengthInput) {
            try {
                const res = await confirm.confirm(internalValue)
